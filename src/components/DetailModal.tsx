...
export default function DetailModal({ selectedFile, closeModal }: DetailModalProps) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50" onClick={closeModal}>
      <div className="bg-white rounded-xl shadow-lg w-full max-w-xl mx-4 p-6 border border-gray-100 relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Uploaded {selectedFile.uploadedAt}</p>
          </div>
        </div>
        ...
        <div className="text-sm text-gray-700 bg-gray-100 p-3 rounded-lg max-h-40 overflow-y-auto">
